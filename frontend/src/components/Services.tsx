...
export default function Services() {
  const { t } = useTranslation('header'); // We can still use the 'header' namespace for now

  return (
    <section className="bg-gray-50 py-16">
      <div className="container mx-auto px-6">
        <div className="bg-white shadow-lg rounded-2xl p-8 max-w-2xl mx-auto -mt-32 relative z-20">
